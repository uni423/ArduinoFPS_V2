...
public class EvolveRbUnit : RabbitUnit
{
    ...
    public override void Initialize()
    {
        ...
        if (GameManager.Instance.gamePlayType == GamePlayerType.Multi)
            unitObject = Multi_InGameManager.PHObjectPooling.PoolInstantiate("Unit/" + this.unitData.model, Vector3.zero, Quaternion.identity).GetComponent<EvolveRbUnitObject>();
